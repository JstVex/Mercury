...
export default function Sidebar() {
    ...
    return (
        <div className="flex items-center justify-between flex-col h-screen w-16 bg-zinc-900 text-white border-r border-zinc-600">
            <div>
                <CgProfile onClick={signout}  className="mt-4" size='30'/>
            </div>
